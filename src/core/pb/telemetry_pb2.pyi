...
class Channel(_message.Message):
    __slots__ = ("id", "name", "source_ref", "units", "type", "scale", "offset")
    ...
    scale: float
    offset: float
    def __init__(self, id: _Optional[int] = ..., name: _Optional[str] = ..., source_ref: _Optional[str] = ..., units: _Optional[str] = ..., type: _Optional[_Union[ValueType, str]] = ..., scale: _Optional[float] = ..., offset: _Optional[float] = ...) -> None: ...
...
class Sample(_message.Message):
    __slots__ = ("channel_id", "t_offset_us", "d", "i", "b", "s", "f", "u")
    ...
    f: float
    u: int
    def __init__(self, channel_id: _Optional[int] = ..., t_offset_us: _Optional[int] = ..., d: _Optional[float] = ..., i: _Optional[int] = ..., b: _Optional[bool] = ..., s: _Optional[str] = ..., f: _Optional[float] = ..., u: _Optional[int] = ...) -> None: ...

class SampleBatch(_message.Message):
    __slots__ = ("registry_seq", "batch_epoch_unix_ms", "batch_epoch_mono_ns", "samples", "format_version")
    REGISTRY_SEQ_FIELD_NUMBER: _ClassVar[int]
    ...
    format_version: int
    def __init__(self, registry_seq: _Optional[int] = ..., batch_epoch_unix_ms: _Optional[int] = ..., batch_epoch_mono_ns: _Optional[int] = ..., samples: _Optional[_Iterable[_Union[Sample, _Mapping]]] = ..., format_version: _Optional[int] = ...) -> None: ...
